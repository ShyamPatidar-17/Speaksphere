        ...
        <div className="p-6 space-y-3">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-200 font-medium group-hover:text-white">Manage Complaints</span>
            </div>
          </button>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-200 font-medium group-hover:text-white">Home</span>
            </div>
          </button>
